...
const NOTIF_META: Record<NotificationType, { icon: React.ComponentType<{ className?: string }>; cls: string }> = {
  ...
  DOCUMENT_UPLOADED: { icon: Upload, cls: "bg-info/10 text-info" },
  DOCUMENT_VERIFIED: { icon: CheckCircle2, cls: "bg-success/10 text-success" },
  DOCUMENT_REJECTED: { icon: XCircle, cls: "bg-destructive/10 text-destructive" },
  DOCUMENT_SHORTFALL: { icon: AlertTriangle, cls: "bg-warning/15 text-warning-foreground" },
