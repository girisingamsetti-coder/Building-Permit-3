  ...
  return (
    <>
      <Dialog open={open} onOpenChange={(o) => !o && handleClose()}>
        <DialogContent
          className="flex max-h-[90vh] w-[96vw] max-w-[1400px] sm:max-w-[1400px] flex-col gap-0 overflow-hidden rounded-xl p-0"
        ...
        >
          ...
          {/* Header (fixed) */}
          <div className="flex items-start justify-between gap-3 border-b border-border px-8 py-4">
          ...
          {/* Footer (fixed) */}
          {!submitted && (
            <div className="flex items-center justify-between gap-3 border-t border-border bg-muted/20 px-8 py-3">
