        ...
        <div ref={infoRef} className="flex flex-col bg-[url('/bg-city.png')] bg-cover bg-center bg-fixed relative border-t border-[#d4af37]/30">
          ...
          <div className="relative z-10 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="min-h-[400px] w-full bg-[url('/bim_sketch.jpg')] bg-contain bg-no-repeat bg-center border-l border-b border-[#d4af37]/30 sepia saturate-[3] hue-rotate-[-10deg] mix-blend-multiply"></div>
            </div>

          {/* What is BBAS? Section */}
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="min-h-[400px] w-full bg-[url('/bbas_sketch.jpg')] bg-cover bg-center border-r border-b border-[#d4af37]/30 order-2 md:order-1 sepia saturate-[3] hue-rotate-[-10deg] mix-blend-multiply"></div>
