...
function LoginForm() {
  ...
  return (
    <div className={cn("relative w-full bg-white", version === "v3" ? "h-screen overflow-y-auto overflow-x-hidden" : "h-screen overflow-hidden")}>
      ...
      {version === "v3" && (
        <div ref={infoRef} className="flex flex-col bg-[url('/bg-city.png')] bg-cover bg-center bg-fixed relative border-t border-[#d4af37]/30">
          <div className="absolute inset-0 bg-white/90 backdrop-blur-xl pointer-events-none" />
          <div className="relative z-10 flex flex-col">
            {/* What is BIM? Section */}
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-12 md:p-24 flex flex-col justify-center">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">What is BIM?</h2>
                <h3 className="text-xl font-semibold text-gray-700 mb-6">Building information modelling</h3>
              ...
              <div className="min-h-[400px] w-full relative border-l border-b border-[#d4af37]/30 bg-[#c5a028]">
                <div className="absolute inset-0 bg-[url('/bim_sketch.jpg')] bg-contain bg-no-repeat bg-center mix-blend-screen grayscale contrast-125"></div>
              </div>
            </div>

          {/* What is BBAS? Section */}
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="min-h-[400px] w-full relative border-r border-b border-[#d4af37]/30 order-2 md:order-1 bg-[#c5a028]">
              <div className="absolute inset-0 bg-[url('/bbas_sketch.jpg')] bg-cover bg-center mix-blend-screen grayscale contrast-125"></div>
            </div>
