    ...
    <div className="flex h-screen w-full overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        ...
        <main className="flex flex-1 flex-col overflow-y-auto">
          <div className="mx-auto w-full max-w-[1440px] px-4 py-6 sm:px-6 lg:px-8 animate-fade-in-up">
            {children}
          </div>
          <footer className="mt-auto border-t border-border bg-muted/30 px-4 py-3 sm:px-6 lg:px-8">
            <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-between gap-2 text-[11px] text-muted-foreground sm:flex-row">
